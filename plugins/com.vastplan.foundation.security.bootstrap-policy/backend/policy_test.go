...
func TestBootstrapBaselineUsesVerifiedNamespaceClassification(t *testing.T) {
	...
	for _, id := range []string{
		"com.vastplan.foundation.security.credentials-bootstrap",
		"com.vastplan.platform.data.database",
	} {
	...
	for _, id := range []string{
		"com.vastplan.product.agent.studio",
		"com.vastplan.example.security.demo",
		"com.example.foundation.security.fake",
	} {
...
func adminUserContext() *contractv1.CallContext {
	return &contractv1.CallContext{
		Caller:    &contractv1.Caller{Kind: contractv1.CallerKind_CALLER_KIND_USER, Id: "admin"},
		Principal: &contractv1.Principal{IsAdmin: true},
	}
}

func pluginContext(id string, inheritedAdmin bool) *contractv1.CallContext {
	return &contractv1.CallContext{
		Caller:    &contractv1.Caller{Kind: contractv1.CallerKind_CALLER_KIND_PLUGIN, Id: id},
		Principal: &contractv1.Principal{IsAdmin: inheritedAdmin},
	}
}
