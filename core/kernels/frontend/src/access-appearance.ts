...
export function accessAppearance(_template: string | undefined): AccessAppearance {
  ...
  return Object.freeze({
    ...
    title:{margin:0,fontSize:24,lineHeight:1.4}, description:{margin:"8px 0 24px",color:"#86909c",lineHeight:1.6}, connecting:{margin:"8px 0 24px",color:"#86909c",lineHeight:1.6},
