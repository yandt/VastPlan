...
const operations = Object.freeze({
  ...
  "platform.artifacts.repository": new Set(["status", "capacity", "listCatalog", "listPublishJournal", "resolve", "listReferences", "setLifecycle", "gcPlan", "gcStatus", "gcQuarantine", "gcSweep", "migrationStatus", "prepareMigration", "syncMigration", "cutoverMigration", "rollbackMigration", "finalizeMigration", "releaseMigration", "listPublications", "submitPublication", "approvePublication", "getSupplyChainEvidence"]),
