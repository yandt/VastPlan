...
const operations = Object.freeze({
  ...
  "platform.credentials": new Set(["list", "listManagedAudit", "put", "rotate", "revoke"]),
  "platform.database": new Set(["list", "define", "remove", "probe"]),
  "platform.artifacts.repository": new Set(["status", "assessmentInventory", "prepareAssessmentReport", "capacity", "listCatalog", "listPublishJournal", "resolve", "listReferences", "setLifecycle", "gcPlan", "gcStatus", "gcQuarantine", "gcSweep", "migrationStatus", "prepareMigration", "syncMigration", "cutoverMigration", "rollbackMigration", "finalizeMigration", "releaseMigration", "listPublications", "submitPublication", "approvePublication", "rejectPublication", "cancelPublication", "getSupplyChainEvidence"]),
  "platform.deployment": new Set(["listNodes", "putNode", "listBootstrapJobs", "createBootstrap", "approveBootstrap", "listDeploymentTargets", "listServiceRevisions", "createServiceDraft", "updateServiceDraft", "createIntentDraft", "updateIntentDraft", "refreshIntentDraft", "submitServiceDraft", "approveServiceRevision", "publishServiceRevision", "rollbackServiceRevision", "listServiceRevisionAudit", "listTestTargetBindings", "putTestTargetBinding", "listTestReleases", "createTestRelease", "rollbackTestRelease"]),
