...
func TestRunValidateMigratesActualStateV1WithoutWriting(t *testing.T) {
  ...
  "updated_at": "2026-07-16T00:00:00Z"
	...
	if !strings.Contains(output.String(), `"schema_version": 4`) || !strings.Contains(output.String(), `"revision": 6`) {
...
func TestRunSupportBundleRedactsSensitiveData(t *testing.T) {
	...
	state := nodeagent.ActualState{
		Version: 4, NodeID: "node-a", ObservedRevision: 8, AppliedRevision: 7,
