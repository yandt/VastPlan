...
func TestPublisherUsesCatalogProfileAndDigestLock(t *testing.T) {
	...
	application := backendcompositionv1.ApplicationComposition{
		...
		Units:    []backendcompositionv1.ApplicationUnit{{ServiceClass: "application.backend", Spec: deploymentv2.ServiceUnit{ID: "api", Kind: "service", Enabled: true, ServiceRole: "backend", Replicas: 2, Plugins: []deploymentv1.PluginRef{{ID: applicationID, Version: "1.0.0", Channel: "stable"}}}}},
	}
