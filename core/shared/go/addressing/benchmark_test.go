...
func BenchmarkBackend_AddressingLocalInvoke(b *testing.B) {
	...
	r.local["demo.echo"] = []localHandler{{record: Announcement{Health: "healthy", Readiness: "ready"}, handler: func(_ context.Context, _ *contractv1.CallTarget, _ *contractv1.CallContext, payload []byte) (*contractv1.CallResult, []byte, error) {
