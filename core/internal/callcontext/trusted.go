...
const (
	ReservedInternalPrefix  = contextview.ReservedInternalPrefix
	ReservedTransportPrefix = contextview.ReservedTransportPrefix
)
...
func isReservedMetadataKey(key string) bool {
	return contextview.IsReservedMetadataKey(key)
}
