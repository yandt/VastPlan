...
> 状态：节点引导与发布 v1、Application Intent/Planner P1—P5、统一插件安装 P0—P2 已实施｜最后更新：2026-08-02
>
...
10. **已实现持久候选 P2**：创建 Installation Candidate 与 ServiceRevision Draft 使用一次 Shared State CAS；候选状态由既有修订状态投影，提交、异人审批、激活、stale 和单调回滚均不另建状态机。取消只允许 Draft，并原子移除草稿、保留候选审计。控制器/服务市场页面仍待 P3/P4 接入。
...
当前 P2 已交付无副作用预览和持久候选生命周期。跨服务页面、服务市场、开发 watch 和全栈 Saga 按 ADR-0191 P3—P6 继续实施。
