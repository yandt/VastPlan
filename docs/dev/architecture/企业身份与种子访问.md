...
> 状态：Provider 管理控制面、OIDC 与数据库 Provider 已实施，可信会话交接待完成｜最后更新：2026-07-23
>
...
| E5 | OIDC Provider（public PKCE 与 confidential Material Lease）；可信会话交接 | 部分实施 |
| E6 | 通用关系数据库用户 Provider；无数据库/故障/恢复集成测试 | 部分实施 |
