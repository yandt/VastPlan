...
- [**插件共享状态服务**](architecture/插件共享状态服务.md)
  - 可信身份派生、单 key CAS、NATS KV/File Provider、多语言 SDK 与迁移顺序
- [**插件分级与组合解析**](architecture/插件分级与组合解析.md)
  - foundation/platform/application 管理边界、Application Intent、Composition Planner 插件、Platform Profile、Application Composition 与解析锁
...
- [ADR-0111 语义图标与 Workbench 页面动作宿主](decisions/ADR-0111-语义图标与Workbench页面动作宿主.md)
- [ADR-0112 PortalPreference 服务端真源与候选提交事务](decisions/ADR-0112-PortalPreference服务端真源与候选提交事务.md)
- [ADR-0113 可信插件配置目录与分路径生效](decisions/ADR-0113-可信插件配置目录与分路径生效.md)
- [ADR-0114 一次性 ConfigurationAuthority 与委托凭证暂存](decisions/ADR-0114-一次性ConfigurationAuthority与委托凭证暂存.md)
- [ADR-0115 Application 配置激活 Saga 与候选凭证窗口](decisions/ADR-0115-Application配置激活Saga与候选凭证窗口.md)
- [ADR-0116 Backend Platform Profile 候选 Catalog 与配置激活](decisions/ADR-0116-Backend-Platform-Profile候选Catalog与配置激活.md)
- [ADR-0117 语言中立 Service Hot 配置控制器](decisions/ADR-0117-语言中立Service-Hot配置控制器.md)
- [ADR-0118 独立配置资源与动态 Profile](decisions/ADR-0118-独立配置资源与动态Profile.md)
- [ADR-0119 Tenant 与 User Scoped Hot 配置真源](decisions/ADR-0119-Tenant与User-Scoped-Hot配置真源.md)
- [ADR-0120 Service Hot 托管凭证提交与退役](decisions/ADR-0120-Service-Hot托管凭证提交与退役.md)
- [ADR-0121 托管凭证过期回收与脱敏审计](decisions/ADR-0121-托管凭证过期回收与脱敏审计.md)
- [ADR-0122 CredentialRef 与 Scoped 配置多语言 SDK](decisions/ADR-0122-CredentialRef与Scoped配置多语言SDK.md)
- [ADR-0123 插件共享状态与可信 Provider](decisions/ADR-0123-插件共享状态与可信Provider.md)
- [ADR-0124 Plugin Settings 租户聚合与 Active-Active 协调](decisions/ADR-0124-Plugin-Settings租户聚合与Active-Active协调.md)
- [ADR-0125 Portal Composer 与 Preference 共享状态分区](decisions/ADR-0125-Portal-Composer与Preference共享状态分区.md)
- [ADR-0126 Deployment Manager 共享账本与副作用 Fencing](decisions/ADR-0126-Deployment-Manager共享账本与副作用Fencing.md)
- [ADR-0127 Credentials 内容寻址快照与 Material Lease 复核](decisions/ADR-0127-Credentials内容寻址快照与Material-Lease复核.md)
- [ADR-0128 统一 Leader Epoch 与外部副作用 Fencing](decisions/ADR-0128-统一Leader-Epoch与外部副作用Fencing.md)
- [ADR-0129 Shared State 签名备份与空目标恢复](decisions/ADR-0129-Shared-State签名备份与空目标恢复.md)
- [ADR-0130 Shared State 容量策略与低基数可观测](decisions/ADR-0130-Shared-State容量策略与低基数可观测.md)
- [ADR-0131 Shared State 与 Vault 有界故障矩阵](decisions/ADR-0131-Shared-State与Vault有界故障矩阵.md)
- [ADR-0132 Credentials 孤儿 Chunk 安全回收](decisions/ADR-0132-Credentials孤儿Chunk安全回收.md)
- [ADR-0133 Credentials 保持 Leader 与 Active-Active 前置条件](decisions/ADR-0133-Credentials保持Leader与Active-Active前置条件.md)
- [ADR-0134 testing 候选与 stable 发布审批绑定](decisions/ADR-0134-testing候选与stable发布审批绑定.md)
- [ADR-0135 插件 SBOM 可信摄取与外置来源证明](decisions/ADR-0135-插件SBOM可信摄取与外置来源证明.md)
- [ADR-0136 外部来源证明 Verifier 与双端复验](decisions/ADR-0136-外部来源证明Verifier与双端复验.md)
- [ADR-0137 Python 标准依赖锁与离线 Overlay](decisions/ADR-0137-Python标准依赖锁与离线Overlay.md)
- [ADR-0138 插件安全准入与可追加复扫状态](decisions/ADR-0138-插件安全准入与可追加复扫状态.md)
- [ADR-0139 安全评估 Provider 与持续复扫控制器](decisions/ADR-0139-安全评估Provider与持续复扫控制器.md)
- [ADR-0140 后台服务自主 HostCall 与宿主绑定上下文](decisions/ADR-0140-后台服务自主HostCall与宿主绑定上下文.md)
- [ADR-0141 扫描数据库不可变快照与评估报告归档](decisions/ADR-0141-扫描数据库不可变快照与评估报告归档.md)
- [ADR-0142 内核启动与业务发布完全分离](decisions/ADR-0142-内核启动与业务发布完全分离.md)
- [ADR-0143 插件化 Application Intent 规划与派生服务依赖](decisions/ADR-0143-插件化应用意图规划与派生依赖.md)
- [ADR-0144 组合服务代际热升级与插件动态调试](decisions/ADR-0144-组合服务代际热升级与插件动态调试.md)
- [ADR-0145 本地测试与正式远端制品仓库双协议](decisions/ADR-0145-本地测试与正式远端制品仓库双协议.md)
- [ADR-0146 开发构建锁一致性与稳定制品身份账本](decisions/ADR-0146-开发构建锁一致性与稳定制品身份账本.md)
- [ADR-0147 种子与在线服务配置统一发布机制](decisions/ADR-0147-种子与在线服务配置统一发布机制.md)
- [ADR-0148 公共服务基线、在线服务配置与种子配置分域](decisions/ADR-0148-公共服务基线与种子配置分域.md)
...
- [插件共享代码与能力复用](architecture/插件共享代码与能力复用.md) —— Contracts、SDK、公共 Library、Provider/Service 插件、多语言交付和依赖门禁
...
- [插件供应链企业验收](guides/插件供应链企业验收.md) —— 准入/复扫有界故障矩阵、生产分权、气隙与目标环境验收
