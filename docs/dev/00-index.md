...
- [平台管理访问策略](plugins/com.vastplan.foundation.security.platform-admin-access-policy.md) —— 五个管理领域的角色授权与受限宿主回调
- [节点部署管理服务](plugins/com.vastplan.platform.infrastructure.deployment-manager.md) —— 节点引导、在线服务组合、异人审批与可信发布
