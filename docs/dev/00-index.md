...
- [**Portal 单 Shell 多模板设计**](architecture/Portal单Shell多模板.md)
  - 单一 Shell 基础插件、稳定 Slot 骨架、侧栏/顶栏模板与用户级切换边界
...
- [数据库连接基础插件](plugins/cn.vastplan.platform.data.relational.connection-manager.md) —— 连接定义、CredentialRef 与可信宿主连通性检查
- [制品仓库基础插件](plugins/cn.vastplan.platform.artifacts.repository.md) —— HTTPS 发布/读取、内核信任适配与兼容自举边界
...
- [本地平台管理中心](guides/本地平台管理中心.md) —— 一键构建并启动本机平台服务、Portal Edge 与管理页面
