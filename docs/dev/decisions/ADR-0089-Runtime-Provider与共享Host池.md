...
- 2026-07-24：按 [ADR-0144](ADR-0144-组合服务代际热升级与插件动态调试.md) 将 service generation 扩展为全部托管 Provider 的硬 Pool key。Node/Python 不再让活动代和候选代共用物理 Host；同一代内仍按服务、Provider、隔离、发布者和兼容摘要共享。缺失 generation 的托管启动请求 fail-closed。
