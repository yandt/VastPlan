...
- [ADR-0009 内核技术栈选型（后端 Go / Desktop Go / 前端 React / 移动 gomobile）](ADR-0009-内核技术栈选型.md)
- [ADR-0010 插件服务与部署编排](ADR-0010-插件服务与部署编排.md)
- [ADR-0011 组合是通用内核能力（服务/门户/客户端App）](ADR-0011-组合是通用内核能力.md)
- [ADR-0012 Desktop（原 APP）内核运行模型：预编译 + 整体热升级](ADR-0012-APP内核运行模型.md)
- [ADR-0013 客户端多档能力：桌面完整 desktop + 手机 Companion](ADR-0013-APP多档能力与手机Companion.md)
- [ADR-0014 四内核结构：拆出 Desktop 内核与移动 Companion 内核](ADR-0014-四内核结构.md)
- [ADR-0015 内核与贡献面命名规范（backend/frontend/desktop/mobile）](ADR-0015-内核与贡献面命名规范.md)
...
- [ADR-0106 多端统一身份授权与 Desktop 执行租约](ADR-0106-多端统一身份授权与Runner执行租约.md)
...
- [ADR-0132 Credentials 孤儿 Chunk 安全回收](ADR-0132-Credentials孤儿Chunk安全回收.md)
- [ADR-0133 Credentials 保持 Leader 与 Active-Active 前置条件](ADR-0133-Credentials保持Leader与Active-Active前置条件.md)
- [ADR-0134 testing 候选与 stable 发布审批绑定](ADR-0134-testing候选与stable发布审批绑定.md)
- [ADR-0135 插件 SBOM 可信摄取与外置来源证明](ADR-0135-插件SBOM可信摄取与外置来源证明.md)
- [ADR-0136 外部来源证明 Verifier 与双端复验](ADR-0136-外部来源证明Verifier与双端复验.md)
...
- [ADR-0141 扫描数据库不可变快照与评估报告归档](ADR-0141-扫描数据库不可变快照与评估报告归档.md)
- [ADR-0142 内核启动与业务发布完全分离](ADR-0142-内核启动与业务发布完全分离.md)
- [ADR-0143 插件化 Application Intent 规划与派生服务依赖](ADR-0143-插件化应用意图规划与派生依赖.md)
- [ADR-0144 组合服务代际热升级与插件动态调试](ADR-0144-组合服务代际热升级与插件动态调试.md)
- [ADR-0145 本地测试与正式远端制品仓库双协议](ADR-0145-本地测试与正式远端制品仓库双协议.md)
- [ADR-0146 开发构建锁一致性与稳定制品身份账本](ADR-0146-开发构建锁一致性与稳定制品身份账本.md)
- [ADR-0147 种子与在线服务配置统一发布机制](ADR-0147-种子与在线服务配置统一发布机制.md)
- [ADR-0148 公共服务基线、在线服务配置与种子配置分域](ADR-0148-公共服务基线与种子配置分域.md)
- [ADR-0149 源码职责规模门禁与渐进拆分](ADR-0149-源码职责规模门禁与渐进拆分.md)
- [ADR-0150 插件共享代码与能力复用边界](ADR-0150-插件共享代码与能力复用边界.md)
- [ADR-0151 最小 Seed 装配与开发插件候选分流](ADR-0151-最小Seed装配与开发插件候选分流.md)
- [ADR-0152 插件边界门禁与权限策略物理收敛](ADR-0152-插件边界门禁与权限策略物理收敛.md)
- [ADR-0153 Kernel Service 可信授权编译](ADR-0153-Kernel-Service可信授权编译.md)
...
- [ADR-0180 Catalog 驱动的统一插件自发现与本地插件库](ADR-0180-Catalog驱动的统一插件自发现与本地插件库.md)
...
- [ADR-0185 四级组件尺寸与组合根继承](ADR-0185-四级组件尺寸与组合根继承.md)
- [ADR-0186 页面正文默认使用 Large](ADR-0186-页面正文默认Large.md)
- [ADR-0187 认证、会话、授权管理与权限判定完全解耦](ADR-0187-认证会话授权四域解耦与快照交付.md)
- [ADR-0188 授权与业务审批策略解耦](ADR-0188-授权与业务审批策略解耦.md)
- [ADR-0189 审批策略 Provider 与声明式规则](ADR-0189-审批策略Provider与声明式规则.md)
- [ADR-0190 Portal 语义导航策略与服务复用](ADR-0190-Portal语义导航策略与服务复用.md)
- [ADR-0191 统一插件安装意图与多入口生命周期控制](ADR-0191-统一插件安装意图与多入口生命周期控制.md)
- [ADR-0192 插件最小升级与兼容影响解析](ADR-0192-插件最小升级与兼容影响解析.md)
- [ADR-0193 第一方插件边界与 Capability 契约版本](ADR-0193-第一方插件边界与Capability契约版本.md)
- [ADR-0194 平台控制数据库与声明式数据分层](ADR-0194-平台控制数据库与声明式数据分层.md)
- [ADR-0195 插件升级前 DataModel 迁移门禁](ADR-0195-插件升级前DataModel迁移门禁.md)
