...
- 2026-07-27：按 [ADR-0161](ADR-0161-产品插件所有权与开发示例物理隔离.md) 将具体 Provider、Trivy 和签名工作流从 SDK 迁回插件内部 `assessmentruntime`；公开复用面只保留协议、Material Lease 客户端和确定性 Trivy revision Library。
