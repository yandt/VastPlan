...
const crossLanguageDigest = "a44835cf60eeb0f0a5b588180074460f74be37c55876e7a955f0b3362519fc7c";
...
test("uses the same canonical digest as the Go manifest validator", () => {
  const graph = {
    ...
    nodes: [
      { path: "frontend/dist/main.js", sha256: "923fe53966c6cd9343e11af776cd4b05be315ea4b200b02e4d5dfb0f929b73bf", size: 5, mediaType: "text/javascript", purpose: "entry", dependencies: [{ path: "frontend/dist/chunks/lazy.js", kind: "dynamic" }] },
