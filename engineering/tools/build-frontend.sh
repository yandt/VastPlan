...
shared=(--external:react --external:react/jsx-runtime --external:react-dom --external:react-dom/client --external:@vastplan/ui-primitives --external:@vastplan/ui-contract --external:@vastplan/workbench-sdk)
