...
func TestPlatformProfileUsesRendererThemeAndIconSelection(t *testing.T) {
	base := currentUIContractJSON(`{"version":1,"revision":1,"id":"theme-template","target":{"kernel":"frontend"},"runtimeEngine":{"id":"cn.vastplan.foundation.frontend.runtime.engine.react","version":"1.0.0","engineContract":"^1.0.0","family":"react"},"renderAdapter":{"id":"cn.vastplan.foundation.frontend.render.adapter","version":"1.0.0","uiContract":"__FRONTEND_UI_CONTRACT__","config":%s},"shell":{"id":"cn.vastplan.foundation.frontend.structure.shell","version":"1.0.0","uiContract":"__FRONTEND_UI_CONTRACT__","config":{"defaultTemplate":"standard","allowedTemplates":["standard"],"userSelectable":false}},"workbench":{"id":"cn.vastplan.foundation.frontend.workflow.workbench","version":"1.0.0","uiContract":"__FRONTEND_UI_CONTRACT__"},"plugins":[{"id":"cn.vastplan.foundation.frontend.runtime.engine.react","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.render.adapter","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.structure.shell","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.workflow.workbench","version":"1.0.0"}],"security":{"firstPartyOnly":true,"requireIntegrity":true}}`)
...
func TestPlatformProfileUpdatePolicy(t *testing.T) {
	base := currentUIContractJSON(`{"version":1,"revision":1,"id":"updates","target":{"kernel":"frontend"},"runtimeEngine":{"id":"cn.vastplan.foundation.frontend.runtime.engine.react","version":"1.0.0","engineContract":"^1.0.0","family":"react"},"renderAdapter":{"id":"cn.vastplan.foundation.frontend.render.adapter","version":"1.0.0","uiContract":"__FRONTEND_UI_CONTRACT__","config":{"defaultRenderer":"arco","allowedRenderers":["arco"],"userSelectable":false}},"shell":{"id":"cn.vastplan.foundation.frontend.structure.shell","version":"1.0.0","uiContract":"__FRONTEND_UI_CONTRACT__","config":{"defaultTemplate":"standard","allowedTemplates":["standard"],"userSelectable":false}},"workbench":{"id":"cn.vastplan.foundation.frontend.workflow.workbench","version":"1.0.0","uiContract":"__FRONTEND_UI_CONTRACT__"},"updates":{"mode":%q},"plugins":[{"id":"cn.vastplan.foundation.frontend.runtime.engine.react","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.render.adapter","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.structure.shell","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.workflow.workbench","version":"1.0.0"}],"security":{"firstPartyOnly":true,"requireIntegrity":true}}`)
