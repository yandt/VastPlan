...
func TestPlatformProfileUpdatePolicy(t *testing.T) {
	base := `{"version":1,"revision":1,"id":"updates","target":{"kernel":"frontend"},"runtimeEngine":{"id":"cn.vastplan.foundation.frontend.runtime.engine.react","version":"1.0.0","engineContract":"^1.0.0","family":"react"},"renderAdapter":{"id":"cn.vastplan.foundation.frontend.render.adapter","version":"1.0.0","uiContract":"^4.0.0","config":{"defaultRenderer":"arco","allowedRenderers":["arco"],"userSelectable":false}},"shell":{"id":"cn.vastplan.foundation.frontend.structure.shell","version":"1.0.0","uiContract":"^4.0.0","config":{"defaultTemplate":"standard","allowedTemplates":["standard"],"userSelectable":false}},"workbench":{"id":"cn.vastplan.foundation.frontend.workflow.workbench","version":"1.0.0","uiContract":"^4.0.0"},"updates":{"mode":%q},"plugins":[{"id":"cn.vastplan.foundation.frontend.runtime.engine.react","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.render.adapter","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.structure.shell","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.workflow.workbench","version":"1.0.0"}],"security":{"firstPartyOnly":true,"requireIntegrity":true}}`
...
func validShellProfileJSON(id string, revision int, shellConfig string, localization ...string) string {
	...
	return fmt.Sprintf(`{"version":1,"revision":%d,"id":"%s","target":{"kernel":"frontend"},"runtimeEngine":{"id":"cn.vastplan.foundation.frontend.runtime.engine.react","version":"1.0.0","engineContract":"^1.0.0","family":"react"},"renderAdapter":{"id":"cn.vastplan.foundation.frontend.render.adapter","version":"1.0.0","uiContract":"^4.0.0","config":{"defaultRenderer":"arco","allowedRenderers":["arco","mui"],"userSelectable":true,"rendererOptions":{"arco":{"themeTemplate":"light"}}}},"shell":{"id":"cn.vastplan.foundation.frontend.structure.shell","version":"1.0.0","uiContract":"^4.0.0","config":%s},"workbench":{"id":"cn.vastplan.foundation.frontend.workflow.workbench","version":"1.0.0","uiContract":"^4.0.0"}%s,"plugins":[{"id":"cn.vastplan.foundation.frontend.runtime.engine.react","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.render.adapter","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.structure.shell","version":"1.0.0"},{"id":"cn.vastplan.foundation.frontend.workflow.workbench","version":"1.0.0"}],"security":{"firstPartyOnly":true,"requireIntegrity":true}}`, revision, id, shellConfig, locale)
}
