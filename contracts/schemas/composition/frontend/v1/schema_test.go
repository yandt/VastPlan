...
func TestFrontendInputsSeparatePlatformAndApplication(t *testing.T) {
	profile, err := ParsePlatformProfile([]byte(`{"version":1,"revision":2,"id":"portal-default","target":{"kernel":"frontend"},"designSystem":{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0","uiContract":"^2.0.0"},"composition":{"id":"com.vastplan.foundation.frontend.composition.standard","version":"1.0.0","uiContract":"^2.0.0","config":{"navigationGroups":[{"id":"operations","label":"运行管理","zone":"primary","icon":"menu"}]}},"layout":{"id":"com.vastplan.foundation.frontend.layout.standard","version":"1.0.0","uiContract":"^2.0.0"},"plugins":[{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0"},{"id":"com.vastplan.foundation.frontend.composition.standard","version":"1.0.0"},{"id":"com.vastplan.foundation.frontend.layout.standard","version":"1.0.0"}],"security":{"firstPartyOnly":true,"requireIntegrity":true}}`))
	if err != nil || profile.Plugins[0].Channel != "stable" || len(profile.Composition.Config.NavigationGroups) != 1 || len(profile.Digest()) != 64 {
...
func TestFrontendInputsRejectBoundaryViolations(t *testing.T) {
	if _, err := ParsePlatformProfile([]byte(`{"version":1,"revision":1,"id":"x","target":{"kernel":"frontend"},"designSystem":{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0","uiContract":"^2"},"plugins":[]}`)); err == nil {
...
func TestPlatformProfileValidatesBoundedNavigationTree(t *testing.T) {
	valid := `{"version":1,"revision":1,"id":"tree","target":{"kernel":"frontend"},"designSystem":{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0","uiContract":"^2.0.0"},"composition":{"id":"com.vastplan.foundation.frontend.composition.standard","version":"1.0.0","uiContract":"^2.0.0","config":{"navigationGroups":[{"id":"operations","label":"运行管理","zone":"primary","icon":"menu"},{"id":"deployments","parentID":"operations","label":"部署","zone":"primary","icon":"menu"}]}},"layout":{"id":"com.vastplan.foundation.frontend.layout.standard","version":"1.0.0","uiContract":"^2.0.0"},"plugins":[{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0"},{"id":"com.vastplan.foundation.frontend.composition.standard","version":"1.0.0"},{"id":"com.vastplan.foundation.frontend.layout.standard","version":"1.0.0"}],"security":{"firstPartyOnly":true,"requireIntegrity":true}}`
	if _, err := ParsePlatformProfile([]byte(valid)); err != nil {
		t.Fatalf("两级导航组应有效: %v", err)
	}

	crossZone := `{"version":1,"revision":1,"id":"tree","target":{"kernel":"frontend"},"designSystem":{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0","uiContract":"^2.0.0"},"composition":{"id":"com.vastplan.foundation.frontend.composition.standard","version":"1.0.0","uiContract":"^2.0.0","config":{"navigationGroups":[{"id":"operations","label":"运行管理","zone":"primary","icon":"menu"},{"id":"settings","parentID":"operations","label":"设置","zone":"settings","icon":"settings"}]}},"layout":{"id":"com.vastplan.foundation.frontend.layout.standard","version":"1.0.0","uiContract":"^2.0.0"},"plugins":[{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0"},{"id":"com.vastplan.foundation.frontend.composition.standard","version":"1.0.0"},{"id":"com.vastplan.foundation.frontend.layout.standard","version":"1.0.0"}],"security":{"firstPartyOnly":true,"requireIntegrity":true}}`
...
func TestFrontendLocalizationPolicyRequiresGovernedDefault(t *testing.T) {
	profile, err := ParsePlatformProfile([]byte(`{"version":1,"revision":1,"id":"localized","target":{"kernel":"frontend"},"designSystem":{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0","uiContract":"^2.0.0"},"composition":{"id":"com.vastplan.foundation.frontend.composition.standard","version":"1.0.0","uiContract":"^2.0.0"},"layout":{"id":"com.vastplan.foundation.frontend.layout.standard","version":"1.0.0","uiContract":"^2.0.0"},"localization":{"defaultLocale":"en-US","supportedLocales":["zh-CN","en-US"]},"plugins":[{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0"},{"id":"com.vastplan.foundation.frontend.composition.standard","version":"1.0.0"},{"id":"com.vastplan.foundation.frontend.layout.standard","version":"1.0.0"}],"security":{"firstPartyOnly":true,"requireIntegrity":true}}`))
...
func validProfile(t *testing.T) PlatformProfile {
	t.Helper()
	profile, err := ParsePlatformProfile([]byte(`{"version":1,"revision":2,"id":"portal-default","target":{"kernel":"frontend"},"designSystem":{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0","uiContract":"^2.0.0"},"composition":{"id":"com.vastplan.foundation.frontend.composition.standard","version":"1.0.0","uiContract":"^2.0.0"},"layout":{"id":"com.vastplan.foundation.frontend.layout.standard","version":"1.0.0","uiContract":"^2.0.0"},"plugins":[{"id":"com.vastplan.foundation.frontend.design-system.arco","version":"1.0.0"},{"id":"com.vastplan.foundation.frontend.composition.standard","version":"1.0.0"},{"id":"com.vastplan.foundation.frontend.layout.standard","version":"1.0.0"}],"security":{"firstPartyOnly":true,"requireIntegrity":true}}`))
	if err != nil {
		t.Fatal(err)
	}
	return profile
