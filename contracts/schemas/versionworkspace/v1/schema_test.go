...
func TestWorkspaceSchemaCompilesWithExactExternalContracts(t *testing.T) {
	...
	for _, definition := range []string{
		"session", "openRequest", "sessionRequest", "revisionRequest", "writeSnapshotRequest", "commitRequest", "renewRequest",
		"sessionResult", "snapshotResult", "changeSummary", "changesResult", "commitResult",
	} {
