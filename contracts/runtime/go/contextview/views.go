// Package contextview exposes defensive semantic views over a host-projected
// CallContext. It never validates ingress or attaches trust; those operations
// remain private to the kernel host.
package contextview
...
// FromWire creates defensive views over an already projected wire
// context. It does not confer trust and is intended for SDK/business readers.
func FromWire(wire *contractv1.CallContext) Views { return viewsFromWire(wire) }
...
// IsReservedMetadataKey identifies host-only namespaces that can never be
// exposed as plugin baggage.
