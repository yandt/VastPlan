...
func TestNodeAgent_ThreeNodeReplicaPlacementAndDriftRecovery(t *testing.T) {
	...
	publishBuiltPlugin(t, repository, "./plugins/com.vastplan.demo-permission/backend", "plugins/com.vastplan.demo-permission/vastplan.plugin.json")
...
func TestNodeAgent_RuntimePublishesRealPluginToNATSMesh(t *testing.T) {
	...
	if err := runtime.Apply(context.Background(), nodeagent.RuntimeUnit{
		...
		Plugins: []nodeagent.InstalledPlugin{
			{ID: "com.vastplan.demo-permission", Version: "0.1.0", EntryPath: buildPlugin(t, "./plugins/com.vastplan.demo-permission/backend")},
			{ID: "com.vastplan.hello-world", Version: "0.1.0", EntryPath: buildPlugin(t, "./plugins/com.vastplan.hello-world/backend")},
		},
	}); err != nil {
		t.Fatal(err)
	}
