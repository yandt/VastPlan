// Package artifactrepository implements deterministic plugin packaging,
// immutable repository storage and signed supply-chain verification shared by
// trusted repository providers and kernel-side adapters.
//
...
// Ref 与 Artifact 保留为兼容别名；稳定 DTO 的单一真源在 contracts/schemas/plugin/v1。
