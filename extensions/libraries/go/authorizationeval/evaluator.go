// Package authorizationeval implements the deterministic, side-effect-free
// Authorization IR evaluator shared by trusted authorization plugins.
package authorizationeval
