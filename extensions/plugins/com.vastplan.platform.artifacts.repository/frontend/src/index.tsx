...
import { managementServicesFor, message, usePortalI18n, usePortalUI, type FrontendPluginContext } from "@vastplan/portal-ui";

const namespace = "com.vastplan.platform.artifacts.repository";
