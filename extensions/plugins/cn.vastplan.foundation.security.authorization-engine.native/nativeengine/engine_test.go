...
func testPolicy(now time.Time) authorizationv1.AuthorizationIR {
	...
	provider := authorizationv1.ProviderProfile{ID: "authorization.native", Revision: 1,
		Store:  authorizationv1.ProviderRef{Protocol: authorizationv1.ProtocolStore, ProviderID: "kernel-shared-state", PluginID: "cn.vastplan.platform.security.authorization-policy", Capability: "platform.authorization.store", Version: "0.2.2", Configuration: configuration},
		Engine: authorizationv1.ProviderRef{Protocol: authorizationv1.ProtocolEngine, ProviderID: "native-rbac", PluginID: "cn.vastplan.foundation.security.authorization-engine.native", Capability: Capability, Version: "0.1.2", Configuration: configuration}, Exchange: []authorizationv1.ProviderRef{}}
