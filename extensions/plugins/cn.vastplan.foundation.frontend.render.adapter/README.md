...
Ant Design、Arco 与 MUI 是该插件的受信任内部 Renderer，Ant Design 是默认首选。Platform Profile 只声明默认 Renderer、允许范围、用户是否可选择，以及每个 Renderer 的主题模板；功能插件始终只依赖 `@vastplan/ui-primitives`。
