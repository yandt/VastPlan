...
const adapter: UIRenderAdapter = {
  ...
  uiContract: "4.0.0",
  renderers: [
    { id: "antd", label: { namespace: "cn.vastplan.foundation.frontend.render.adapter", key: "renderer.antd", fallback: "Ant Design" }, framework: "antd", module: { id: "cn.vastplan.foundation.frontend.render.adapter.antd", version: "1.0.1", channel: "stable" } },
    ...
    { id: "mui", label: { namespace: "cn.vastplan.foundation.frontend.render.adapter", key: "renderer.mui", fallback: "Material UI" }, framework: "mui", module: { id: "cn.vastplan.foundation.frontend.render.adapter.mui", version: "1.7.4", channel: "stable" } },
  ],
