...
const adapter: UIRenderAdapter = {
  ...
  uiContract: "4.0.0",
  renderers: [
    { id: "arco", label: { namespace: "cn.vastplan.foundation.frontend.render.adapter", key: "renderer.arco", fallback: "Arco Design" }, framework: "arco", module: { id: "cn.vastplan.foundation.frontend.render.adapter.arco", version: "1.6.0", channel: "stable" } },
    { id: "mui", label: { namespace: "cn.vastplan.foundation.frontend.render.adapter", key: "renderer.mui", fallback: "Material UI" }, framework: "mui", module: { id: "cn.vastplan.foundation.frontend.render.adapter.mui", version: "1.7.0", channel: "stable" } },
  ],
