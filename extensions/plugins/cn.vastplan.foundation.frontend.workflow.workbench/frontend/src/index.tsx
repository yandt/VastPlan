...
export const workbench: UIWorkbenchAdapter = {
  ...
  localization: {
    ...
    messages: {
      "zh-CN": {
        "action.refresh": "刷新", "action.clearFilters": "清除筛选", "action.columns": "列设置", "action.more": "更多页面操作", "action.moreRow": "更多行操作", "column.actions": "操作",
        "action.running": "正在{action}…", "action.runningTitle": "正在处理", "action.runningDescription": "操作正在执行，请勿关闭页面。",
        ...
        "dashboard.move": "拖动卡片", "dashboard.cardMissing": "卡片内容不可用",
        "value.yes": "是", "value.no": "否",
      },
      "en-US": {
        "action.refresh": "Refresh", "action.clearFilters": "Clear filters", "action.columns": "Columns", "action.more": "More page actions", "action.moreRow": "More row actions", "column.actions": "Actions",
        "action.running": "{action} in progress…", "action.runningTitle": "Working", "action.runningDescription": "This action is still running. Keep this page open.",
        ...
        "dashboard.move": "Move card", "dashboard.cardMissing": "Card content is unavailable",
