  ...
  localization: {
    ...
    messages: {
      "zh-CN": {
        ...
        "form.discardTitle": "放弃未保存的修改？", "form.discardContent": "关闭后，本次输入不会保留。", "action.cancel": "取消", "action.submit": "提交", "action.previous": "上一步", "action.next": "下一步",
      },
      "en-US": {
        ...
        "form.discardTitle": "Discard unsaved changes?", "form.discardContent": "Your current input will not be kept.", "action.cancel": "Cancel", "action.submit": "Submit", "action.previous": "Previous", "action.next": "Next",
      },
    },
  },
};
