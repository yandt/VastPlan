...
export function DashboardGrid({ spec, cards, layouts, editable = false, onLayoutChange }: DashboardGridRuntimeProps) {
  ...
  return <ComponentSizeProvider size={spec.size}><div ref={containerRef as RefObject<HTMLDivElement>} style={rootStyle} data-vastplan-dashboard-grid={spec.id}>
