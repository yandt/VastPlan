export const messages = {
  "zh-CN": {
    ...
    "market.versionPolicy": "版本策略", "market.exact": "固定当前版本", "market.compatible": "允许兼容升级", "market.created": "已创建插件安装候选",
    "tasks.title": "安装任务", "tasks.description": "查看当前服务的插件候选、审批与 Generation 滚动状态", "tasks.status": "状态", "tasks.updated": "更新时间",
  ...
  "en-US": {
    ...
    "market.versionPolicy": "Version policy", "market.exact": "Pin this version", "market.compatible": "Allow compatible upgrades", "market.created": "Plugin installation candidate created",
    "tasks.title": "Installation tasks", "tasks.description": "Review candidates, approval and Generation rollout for this service", "tasks.status": "Status", "tasks.updated": "Updated",
    "action.submit": "Submit", "action.approve": "Approve", "action.activate": "Activate", "action.cancel": "Cancel", "action.rollback": "Rollback", "action.preview": "Preview"
  }
} as const;
