...
const plugin = {
  register(context: WorkbenchFrontendPluginContext) {
    ...
    context.addCollectionPage(createMarketPage(marketplace, deployment, "/operations/service-plugins/marketplace", context.i18n.message));
    context.addCollectionPage(createTaskPage(deployment, "/operations/service-plugins/tasks", context.i18n.message));
  },
