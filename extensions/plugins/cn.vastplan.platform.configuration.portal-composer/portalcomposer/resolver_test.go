...
func testProfile() frontendcompositionv1.PlatformProfile {
	...
	return frontendcompositionv1.PlatformProfile{Document: compositioncommonv1.Document{Version: 1, Revision: 1, ID: "portal-default"}, Target: compositioncommonv1.Target{Kernel: compositioncommonv1.KernelFrontend}, RuntimeEngine: frontendcompositionv1.RuntimeEngine{PluginRef: engine, EngineContract: "^1.0.0", Family: "react"}, RenderAdapter: frontendcompositionv1.RenderAdapter{PluginRef: design, UIContract: "^5.0.0", Config: frontendcompositionv1.RenderAdapterConfig{DefaultRenderer: "arco", AllowedRenderers: []string{"arco", "mui"}, UserSelectable: true, RendererOptions: map[string]frontendcompositionv1.RendererOptions{"arco": {ThemeTemplate: "light", IconTheme: "canonical"}}}}, Shell: frontendcompositionv1.Shell{PluginRef: shell, UIContract: "^5.0.0", Config: frontendcompositionv1.ShellConfig{NavigationConfig: frontendcompositionv1.NavigationConfig{NavigationGroups: []frontendcompositionv1.NavigationGroupDescriptor{{ID: "operations", Label: "运行管理", Zone: "primary", Icon: "menu"}}}, DefaultTemplate: "standard", AllowedTemplates: []string{"standard", "top-navigation"}, UserSelectable: true, TemplateOptions: map[string]map[string]any{"standard": {}}}}, Workbench: frontendcompositionv1.Workbench{PluginRef: workbench, UIContract: "^5.0.0"}, Plugins: []frontendcompositionv1.PluginRef{engine, design, shell, workbench}, Security: frontendcompositionv1.SecurityPolicy{FirstPartyOnly: true, RequireIntegrity: true}}
}
