...
export function createPortalPage(client: PortalControlClient, permissionCatalog: PortalPermissionCatalogClient): CollectionPageDefinition<PortalRow> {
  return defineCollectionPage<PortalRow>({
    ...
    navigation: { id: "platform.portal-composer", label: message(namespace, "page.navigation", "Portal 管理"), parentMenuRef: { pluginID: "cn.vastplan.platform.configuration.portal-composer", nodeID: "portal-management" }, order: 11 },
    collection: {
    ...
    async loadSummary() {
      ...
      return { appearance: "plain", size: "sm", columns: { xs: 1, sm: 1, md: 2, lg: 2, xl: 2 }, metrics: [
