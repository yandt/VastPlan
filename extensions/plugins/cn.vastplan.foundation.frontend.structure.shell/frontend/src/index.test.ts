...
describe("Shell Catalog", () => {
  it("owns semantics while locking visual libraries as independent modules", () => {
    ...
    expect(shell.templates).toMatchObject([
      { id: "standard", module: { id: "cn.vastplan.foundation.frontend.structure.layout.standard", version: "1.2.3", channel: "stable" } },
      { id: "top-navigation", module: { id: "cn.vastplan.foundation.frontend.structure.layout.top-navigation", version: "1.2.3", channel: "stable" } },
    ]);
