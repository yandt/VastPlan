...
func plannerFixture(t *testing.T, auditPolicy string) *planningRepository {
    ...
    "runtime":{"instancePolicy":"active-active","stateModel":"external-shared","visibility":"cluster","routing":"queue","routingDomain":"application","provides":[{"extensionPoint":"tool.package","capability":"agent.api","visibility":"cluster","routing":"queue","routingDomain":"application"}],"requires":[{"capability":"platform.settings","scope":"remote","kind":"strong","ready":"readiness","failurePolicy":"fail","logicalService":"platform.settings","routingDomain":"platform"}]},
    "contributes":{"backend":{"tools":[{"id":"agent.api","service_role":"backend","title":"API","subcommands":[]}]}}`)
	auditRuntime := `"runtime":{"instancePolicy":"active-active","stateModel":"external-shared","visibility":"cluster","routing":"queue","routingDomain":"application"}`
	if auditPolicy == "leader" {
		auditRuntime = `"runtime":{"instancePolicy":"leader","stateModel":"leader-owned","visibility":"cluster","routing":"leader","routingDomain":"application"}`
	}
    ...
    "runtime":{"instancePolicy":"leader","stateModel":"leader-owned","visibility":"cluster","routing":"leader","routingDomain":"platform","provides":[{"extensionPoint":"tool.package","capability":"platform.settings","visibility":"cluster","routing":"leader","routingDomain":"platform"}]},
