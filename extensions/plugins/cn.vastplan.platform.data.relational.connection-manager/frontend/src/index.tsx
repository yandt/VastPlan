...
export default {
  register(context: WorkbenchFrontendPluginContext) {
    ...
    for (const service of services) {
      ...
      context.addFormPage(createPlatformControlPage(client, service.id, `/settings/databases/platform-control${suffix}`));
