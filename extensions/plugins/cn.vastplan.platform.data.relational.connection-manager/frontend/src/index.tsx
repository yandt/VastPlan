  ...
  const form = (id: "create" | "edit"): WorkbenchFormDefinition<DatabaseRow> => ({
    ...
    presentation: {
      ...
      sections: [
        ...
        { id: "options", title: message(namespace, "section.options", "Provider 连接选项"), columns: 2, fields: ["/options"] },
        { id: "pool", title: message(namespace, "section.pool", "连接池策略"), columns: 2, fields: ["/pool"] },
        { id: "credential", title: message(namespace, "section.credential", "托管凭证"), columns: 2, fields: ["/credentialValue"] },
      ],
      fields: [
