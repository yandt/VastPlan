...
export const localization = {
  ...
  messages: {
    "zh-CN": {
      ...
      "appearance.preferences": "偏好设置", "appearance.preferencesHint": "切换后立即生效", "appearance.theme": "主题与颜色", "appearance.themeHint": "分别配置浅色与深色模式",
    ...
    "en-US": {
      ...
      "appearance.preferences": "Preferences", "appearance.preferencesHint": "Changes take effect immediately", "appearance.theme": "Theme and colors", "appearance.themeHint": "Configure light and dark modes separately",
