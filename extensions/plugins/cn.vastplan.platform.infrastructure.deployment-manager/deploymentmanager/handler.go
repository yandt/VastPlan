...
func errorCode(err error) string {
	...
	case errors.Is(err, errInstallationApprovalDenied):
...
func Descriptor() []byte {
	return []byte(`{"title":"部署与测试发布管理","subcommands":[
		...
		,{"name":"applyDevelopmentPluginInstallation","description":"由受信开发控制器在同一候选链中自动提交并激活","paramsSchema":{"type":"object","additionalProperties":false,"properties":{"installationPreview":{"type":"object"}},"required":["installationPreview"]}}
		...
		,{"name":"submitSelfServicePluginInstallationCandidate","description":"重新规划并提交绑定服务的自助安装候选","paramsSchema":{"type":"object","additionalProperties":false,"properties":{"candidateId":{"type":"string"},"installationTarget":{"type":"object"}},"required":["candidateId","installationTarget"]}}
		,{"name":"approveSelfServicePluginInstallationCandidate","description":"按审批策略批准绑定服务的自助安装候选","paramsSchema":{"type":"object","additionalProperties":false,"properties":{"candidateId":{"type":"string"},"installationTarget":{"type":"object"},"approvalEvidence":{"type":"object","maxProperties":32}},"required":["candidateId","installationTarget"]}}
		,{"name":"activateSelfServicePluginInstallationCandidate","description":"激活绑定服务的自助安装候选","paramsSchema":{"type":"object","additionalProperties":false,"properties":{"candidateId":{"type":"string"},"installationTarget":{"type":"object"}},"required":["candidateId","installationTarget"]}}
		,{"name":"cancelSelfServicePluginInstallationCandidate","description":"取消绑定服务尚未提交的自助安装候选","paramsSchema":{"type":"object","additionalProperties":false,"properties":{"candidateId":{"type":"string"},"installationTarget":{"type":"object"}},"required":["candidateId","installationTarget"]}}
		,{"name":"rollbackSelfServicePluginInstallationCandidate","description":"回滚绑定服务已激活的自助安装候选","paramsSchema":{"type":"object","additionalProperties":false,"properties":{"candidateId":{"type":"string"},"installationTarget":{"type":"object"}},"required":["candidateId","installationTarget"]}}
...
func Contribution(service *Service) sdk.Contribution {
	...
	operations := []string{"listNodes", "putNode", "listBootstrapJobs", "createBootstrap", "approveBootstrap", "listDeploymentTargets", "listServiceRevisions", plugininstallation.PreviewOperation, plugininstallation.SelfServicePreviewOperation, plugininstallation.DevelopmentPreviewOperation, plugininstallation.CreateOperation, plugininstallation.SelfServiceCreateOperation, plugininstallation.DevelopmentCreateOperation, plugininstallation.DevelopmentApplyOperation, plugininstallation.ListTargetsOperation, plugininstallation.ListOperation, plugininstallation.GetOperation, plugininstallation.SubmitOperation, plugininstallation.ApproveOperation, plugininstallation.ActivateOperation, plugininstallation.CancelOperation, plugininstallation.RollbackOperation, plugininstallation.SelfServiceListOperation, plugininstallation.SelfServiceGetOperation, plugininstallation.SelfServiceSubmitOperation, plugininstallation.SelfServiceApproveOperation, plugininstallation.SelfServiceActivateOperation, plugininstallation.SelfServiceCancelOperation, plugininstallation.SelfServiceRollbackOperation, "createIntentDraft", "updateIntentDraft", "refreshIntentDraft", "bindIntentConfiguration", "submitServiceDraft", "approveServiceRevision", "publishServiceRevision", "rollbackServiceRevision", configurationactivation.CreateOperation, configurationactivation.GetOperation, configurationactivation.PublishOperation, platformprofileactivation.CreateActivationOperation, platformprofileactivation.GetActivationOperation, platformprofileactivation.ApproveActivationOperation, platformprofileactivation.PublishActivationOperation, platformprofileactivation.AbortActivationOperation, "listServiceRevisionAudit", "listTestTargetBindings", "putTestTargetBinding", "listTestReleases", "createTestRelease", "rollbackTestRelease"}
