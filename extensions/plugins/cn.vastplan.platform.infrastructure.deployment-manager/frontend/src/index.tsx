  ...
  return defineCollectionPage<DeploymentRow>({
    ...
    collection: { id: `platform.deployment.${serviceID}`, title, view: "table", query: { mode: "page", defaultPageSize: 20, pageSizeOptions: [20, 50, 100] },
      ...
      actions: [
        ...
        { id: "publish", label: localizedMessage(namespace,"action.publish","发布"), icon: "publish", placement: "page.secondary", requiresSelection: true, tone: "primary", confirm: localizedMessage(namespace,"confirm.publish","发布后 Controller 会把副本调度到符合条件的 Node Agent。"), visibleWhen: { pointer: "/status", in: ["Approved", "Publishing"] } },
