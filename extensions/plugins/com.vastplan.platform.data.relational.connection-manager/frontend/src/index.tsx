...
import { jsonSchemaDialect, managementServicesFor, message as localizedMessage, usePortalMessages, usePortalUI, type FormSchema, type FrontendPluginContext } from "@vastplan/portal-ui";

const namespace = "com.vastplan.platform.data.relational.connection-manager";
