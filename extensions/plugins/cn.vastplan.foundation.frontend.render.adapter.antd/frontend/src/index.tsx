  ...
  localization: {
    ...
    messages: {
      "zh-CN": {
        ...
        "form.duration.unit": "时间单位", "form.duration.millisecond": "毫秒", "form.duration.second": "秒", "form.duration.minute": "分", "form.duration.hour": "小时", "form.duration.day": "天", "form.duration.week": "周", "form.duration.month": "月",
      ...
      "en-US": {
        ...
        "form.duration.unit": "Time unit", "form.duration.millisecond": "ms", "form.duration.second": "sec", "form.duration.minute": "min", "form.duration.hour": "hour", "form.duration.day": "day", "form.duration.week": "week", "form.duration.month": "month",
