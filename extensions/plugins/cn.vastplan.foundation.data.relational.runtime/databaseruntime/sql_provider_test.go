...
func TestSQLValueConversionAndStableErrorClasses(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{err: &pgconn.PgError{Code: "23505"}, code: databasev1.ErrorConstraintViolation, retryable: false},
		...
		{err: &mysql.MySQLError{Number: 1062}, code: databasev1.ErrorConstraintViolation, retryable: false},
