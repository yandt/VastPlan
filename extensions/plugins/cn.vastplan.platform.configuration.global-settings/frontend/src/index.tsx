...
import { jsonSchemaDialect, managementServicesFor, message, usePortalI18n, usePortalUI, type FormSchema, type FrontendPluginContext } from "@vastplan/ui-primitives";
