...
统一 Adapter 负责目录、Profile 治理和切换安全；MUI Renderer 提供布局、导航、弹层、JSON Schema 表单、数据展示、反馈和主题实现，1.1 同步提供 Workbench Card/Cursor，1.2 同步提供 sections/tabs/steps、分栏、异步校验和字段错误映射，1.3 同步提供受治理的 `secretMaterial` password 呈现。Portal Generation 不会混用 MUI 与 Arco。
