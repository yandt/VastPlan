...
import { jsonSchemaDialect, managementServicesFor, message as localizedMessage, usePortalI18n, usePortalMessages, usePortalUI, type FormSchema, type FrontendPluginContext, type StatusTone } from "@vastplan/portal-ui";

const namespace = "com.vastplan.platform.infrastructure.deployment-manager";
