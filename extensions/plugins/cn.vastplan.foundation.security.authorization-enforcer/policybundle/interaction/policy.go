// Package interaction implements the coarse permission boundary for interaction
...
func BrokerPluginID() string { return "cn.vastplan.platform.interaction.broker" }
