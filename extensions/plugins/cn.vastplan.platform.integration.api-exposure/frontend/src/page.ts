...
export function createAPIExposurePage(
  ...
  return defineCollectionPage<APIExposureRow>({
    ...
    navigation: { id: `platform.api-exposure.${serviceID}`, label: text("page.navigation", "HTTP API"), parentMenuRef: { pluginID: "cn.vastplan.platform.integration.api-exposure", nodeID: "integration" }, managementServiceID: serviceID, order: 55 },
    collection: {
