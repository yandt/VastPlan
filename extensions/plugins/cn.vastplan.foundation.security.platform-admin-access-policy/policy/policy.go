...
func operationRole(capability, operation string) string {
	roles := map[string]map[string]string{
		...
		platformadminapi.ArtifactsCapability:   {"status": "platform.artifacts.read", "listCatalog": "platform.artifacts.read", "listPublishJournal": "platform.artifacts.read", "resolve": "platform.artifacts.read", "listReferences": "platform.artifacts.read", "gcPlan": "platform.artifacts.read", "gcStatus": "platform.artifacts.read", "setLifecycle": "platform.artifacts.lifecycle", "gcQuarantine": "platform.artifacts.gc", "gcSweep": "platform.artifacts.gc", "migrationStatus": "platform.artifacts.read", "prepareMigration": "platform.artifacts.migrate", "syncMigration": "platform.artifacts.migrate", "cutoverMigration": "platform.artifacts.migrate", "rollbackMigration": "platform.artifacts.migrate", "finalizeMigration": "platform.artifacts.migrate", "releaseMigration": "platform.artifacts.migrate"},
