...
@media (max-width:1199px){.vp-top-bar{grid-template-columns:minmax(160px,auto) minmax(0,1fr) auto;padding:0 14px}.vp-top-root-trigger{padding:0 9px}.vp-top-child-grid{grid-template-columns:repeat(2,minmax(220px,1fr))}.vp-top-page{padding:var(--vp-page-content-start) 20px 20px}}
