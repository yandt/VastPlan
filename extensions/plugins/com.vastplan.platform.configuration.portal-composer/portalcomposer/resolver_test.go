...
func TestResolveInjectsPlatformDesignSystemAndLocksInputs(t *testing.T) {
	...
	if len(resolved.Composition.Config.NavigationGroups) == 0 {
...
func testProfile() frontendcompositionv1.PlatformProfile {
	...
	return frontendcompositionv1.PlatformProfile{Document: compositioncommonv1.Document{Version: 1, Revision: 1, ID: "portal-default"}, Target: compositioncommonv1.Target{Kernel: compositioncommonv1.KernelFrontend}, DesignSystem: frontendcompositionv1.DesignSystem{PluginRef: design, UIContract: "^2.0.0"}, Composition: frontendcompositionv1.ShellComposition{PluginRef: composition, UIContract: "^2.0.0", Config: frontendcompositionv1.NavigationConfig{NavigationGroups: []frontendcompositionv1.NavigationGroupDescriptor{{ID: "operations", Label: "运行管理", Zone: "primary", Icon: "menu"}}}}, Layout: frontendcompositionv1.ShellLayout{PluginRef: layout, UIContract: "^2.0.0"}, Plugins: []frontendcompositionv1.PluginRef{design, composition, layout}, Security: frontendcompositionv1.SecurityPolicy{FirstPartyOnly: true, RequireIntegrity: true}}
}
