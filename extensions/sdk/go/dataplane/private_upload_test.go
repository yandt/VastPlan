...
func TestIssuePrivateGrantUsesTrustedCapability(t *testing.T) {
	caller := &grantCaller{}
	call := &contractv1.CallContext{TenantId: "tenant-a", Caller: &contractv1.Caller{Kind: contractv1.CallerKind_CALLER_KIND_DESKTOP, Id: "desktop-a"}, Principal: &contractv1.Principal{UserId: "alice"}}
