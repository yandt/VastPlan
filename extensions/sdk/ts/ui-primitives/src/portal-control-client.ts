...
export interface PortalPlatformProfile {
  ...
  shell: PortalPluginRef & { uiContract: string; config: { navigationOverrides?: JSONValue; navigationFolders?: JSONValue; defaultTemplate: string; allowedTemplates: string[]; userSelectable: boolean; templateOptions?: Record<string, Record<string, JSONValue>> } };
