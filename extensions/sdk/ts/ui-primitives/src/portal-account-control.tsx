...
import type { PopoverTriggerProps, TooltipPlacement } from "./primitives.js";
...
export function PortalAccountControl({ account, selected, onSelect, trigger, tooltipPlacement }: {
  account: PortalAccountSummary;
  selected?: boolean;
  onSelect?(): void;
  trigger?: PopoverTriggerProps;
  /** Layout-owned placement for the account trigger's explanatory tooltip. */
  ...
  return <ui.Tooltip title={summary} placement={tooltipPlacement}>
    <button
